...
public enum GroupParams implements NamedEnum {
    ...
    COORDS("Координаты", List.of("первую координату (x, целое число)", "вторую координату (y, целое число)")),
    STUDENTS_COUNT("Количество студентов", "количество студентов (целое число, больше 0)"),
